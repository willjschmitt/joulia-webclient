(function loadSidebarBreweryDirective() {
  angular
    .module('app.common')
    .directive('sidebarBrewery', sidebarBrewery);

  sidebarBrewery.$inject = ['breweryResources'];

  function sidebarBrewery(breweryResources) {
    return {
      restrict: 'A',
      transclude: true,
      scope: {
      ...
      link: function sidebarBreweryController($scope) {
